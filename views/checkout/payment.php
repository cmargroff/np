...
<div class="alt-payment-methods checkset">
		...
		foreach ($model->simPaymentModulesNoCard as $id => $option)
		{
			...
			echo $form->labelEx(
				$model,
				'paymentProvider',
				array('class' => 'checklabel payment-method', 'label' => Yii::t('checkout', $option), 'for' => 'MultiCheckoutForm_paymentProvider_'.$id)
			);
		}
		?>
</div>
